...
String mainurl="https://api.railwayapi.com/v2/check-seat/train/"+train_number+"/source/"+source+"/dest/"+destination+"/date/"+d+"/pref/"+pref+"/quota/"+quota+"/apikey/p8onwdgigu/";
